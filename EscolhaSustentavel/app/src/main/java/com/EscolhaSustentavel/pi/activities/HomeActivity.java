...
import static com.EscolhaSustentavel.pi.R.id.iv_profile_drawer;
...
public class HomeActivity extends AppCompatActivity implements DrawerFragment.OnDrawerLeftActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(urlfoto).into(iv_profile_drawer);
    ...
    private void setimage() {
        try {
            String nameFile = urlfoto.substring(urlfoto.lastIndexOf('/'));
            InputStream ims = getAssets().open(nameFile.substring(1));
            Drawable d = Drawable.createFromStream(ims, null);
            iv_profile_drawer.setImageDrawable(d);
